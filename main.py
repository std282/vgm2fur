...
fm_chip, psg_chip = transform.tabulate(song.events, song.total_wait, period=735, chips=['ym2612', 'sn76489'])
print('Translating state table to tracker events...')
psg1, psg2, psg3, noise = transform.to_patterns_psg(psg_chip)
fm1, fm2, fm3, fm4, fm5, fm6 = _split_fm(fm_chip)
...
voices = _collect_voices([fm1, fm2, fm3, fm4, fm5, fm6], init=fur.instrument_count)
...
fur.add_patterns(_transform(fm1, voices, 0), 'fm1')
fur.add_patterns(_transform(fm2, voices, 0), 'fm2')
fur.add_patterns(_transform(fm3, voices, 1), 'fm3')
fur.add_patterns(_transform(fm4, voices, 0), 'fm4')
fur.add_patterns(_transform(fm5, voices, 0), 'fm5')
fur.add_patterns(_transform(fm6, voices, 2), 'fm6')
fur.add_patterns(psg1, 'psg1')
fur.add_patterns(psg2, 'psg2')
fur.add_patterns(psg3, 'psg3')
fur.add_patterns(noise, 'noise')
fur.ym2612_volume = 0.6
